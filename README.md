...
|---:|---|:---:|---|
| 1 | 동네 지붕 | — | 연습. 편하게 쌓아보자 |
| 2 | 새들의 길 | 🐦 | 새가 지나갈 땐 쌓지 마 |
| 3 | 구름 바다 | ☁️ | 구름이 덮칠 때 기다려 |
| 4 | 연의 축제 | 🪁 | 연이 대각선으로 스쳐 간다 |
| 5 | 풍선 마을 | 🎈 | 풍선이 아래서 떠오른다 |
| 6 | 유령의 숲 | 👻 | 반투명 유령이 스멀스멀 |
| 7 | 구름 고양이 | 🐱 | 고양이가 한가롭게 멈춰 선다 |
| 8 | 번개 구름 | ⚡ | 번개가 치는 순간 피해! |
| 9 | 유성우 | ☄️ | 유성이 빠르게 쏟아진다 |
| 10 | 달의 곶 | ☄️ | 마지막 — 달님이 기다린다 |
